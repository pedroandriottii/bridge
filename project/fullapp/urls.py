...
from .views import signin, signup, demands, home, add_embassador, add_manager, logout, index, demand_create, my_demands, signup_user2, demands_by_region, signup_user3, triagem, aprovar_triagem, rejeitar_triagem
